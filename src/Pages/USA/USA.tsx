...
function USA(): JSX.Element {
  ...
  const isLoading = useSelector((state: RootState) => state.usaNews.loading);
  const isError = useSelector((state: RootState) => state.usaNews.error);
